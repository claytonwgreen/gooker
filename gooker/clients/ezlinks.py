...
class LosRoblesClient(EZLinksBaseClient):
    ...
    courses = [
        base.Course(
            ...
            is_9_hole=False,
            is_par_70_plus=True,
            booking_info="https://losrobles.ezlinksgolf.com/index.html#/search",
        )
    ]
...
class TeirraRejadaClient(EZLinksBaseClient):
    ...
    courses = [
        base.Course(
            ...
            booking_info="https://tierrarejadapubpp.ezlinksgolf.com/index.html#/search",
        ),
        base.Course(
            name="Tierra Rejada",
            id=19894,
...
class LACityClient(EZLinksBaseClient):
    ...
    courses = [
        base.Course(
            ...
            is_9_hole=False,
            is_par_70_plus=True,
            booking_info="https://cityofla.ezlinksgolf.com/index.html#/preSearch",
        ),
        base.Course(
            name="Wilson",
            id=5998,
